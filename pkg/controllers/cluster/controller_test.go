...
func assertOperatorSecretInvariants(t *testing.T, controller *MySQLController, cluster *api.MySQLCluster) {
	...
	secret, err := controller.kubeClient.CoreV1().Secrets(cluster.Namespace).Get(context.TODO(), secretName, metav1.GetOptions{})
	if err != nil {
...
func assertOperatorServiceInvariants(t *testing.T, controller *MySQLController, cluster *api.MySQLCluster) {
	...
	service, err := kubeClient.CoreV1().Services(cluster.Namespace).Get(context.TODO(), cluster.Name, metav1.GetOptions{})
	if err != nil {
...
func assertOperatorVersionInvariants(t *testing.T, controller *MySQLController, namespace string, name string, version string) {
	...
	updatedPodList, err := controller.kubeClient.CoreV1().Pods(namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
