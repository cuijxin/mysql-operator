	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.Mysql5V1().MySQLBackups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Mysql5V1().MySQLBackups(namespace).Watch(context.TODO(), options)
			},
		},
		&mysqlv1.MySQLBackup{},
		resyncPeriod,
...
func (f *mySQLBackupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mysqlv1.MySQLBackup{}, f.defaultInformer)
}
